export const LogoIcon = () => (
    <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "90", height: "20"}}>
...
export const SearchIcon = () => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "20", height: "20"}}>
        <g className="style-scope yt-icon">
            <path
...
export const PlayIcon = () => (
    <svg height="46" version="1.1" viewBox="0 0 36 36" width="40">
        <path className="ytp-svg-fill" d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z"/>
    </svg>
)
...
export const FlagIcon = () => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "24", height: "24"}}>
        <g className="style-scope yt-icon">
            <path d="M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z" className="style-scope yt-icon"/>
        </g>
    </svg>
)
...
export const SportsIcon = () => (
    <img height="24" width="24" alt="" style={{borderRadius: "50%"}}
         src="https://yt3.ggpht.com/vp6alRt4BRmfvJmvEsXcB_iyeQiMSm1z2Q0FV7XFlXzcmu2wCL06x_YT9StxOS8z57Cd7EL_4w=s88-c-k-c0x00ffffff-no-rj"/>
)
...
export const NewsIcon = () => (
    <img height="24" width="24" alt="" style={{borderRadius: "50%"}}
         src="https://yt3.ggpht.com/bssm4mEw5OtrBUftn8rrcVTiM3mAImsDo8h-WZrUewuae1xiEYXhJod4Rud0TYnh3cGSiyW5aw=s88-c-k-c0x00ffffff-no-rj"/>
)
...
export const SpotlightIcon = () => (
    <img height="24" width="24" alt="" style={{borderRadius: "50%"}}
         src="https://yt3.ggpht.com/ytc/AKedOLScVafuOA02cwGYT8SOGqV1F3OxXpJfuFdaHwhr9g=s88-c-k-c0x00ffffff-no-rj"/>
)

export const Video360Icon = () => (
    <img height="24" width="24" alt="" style={{borderRadius: "50%"}}
         src="https://yt3.ggpht.com/L_jTYfooAGaJFdR4sNZkLoOStbFM7-Gz1M-fkLW6JGFKFAIg0p9Elnq5FqpZHO2wOeVkv4iY6vc=s88-c-k-c0x00ffffff-no-rj"/>
)

export const BrowseChannelsIcon = () => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "24", height: "24"}}>
        <g className="style-scope yt-icon">
            <path
...
export const RightIcon = () => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "24", height: "24", fill: `#909090`}}>
        <g mirror-in-rtl="" className="style-scope yt-icon">
            <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" className="style-scope yt-icon"/>
        </g>
    </svg>
)
    ...
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
        ...
        <g className="style-scope yt-icon">
            <path
                ...
                transform="translate(-272, -198)" className="style-scope yt-icon"/>
        </g>
    </svg>
)
...
export const YourDataInYoutubeIcon = () => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "24", height: "24", fill: `#909090`}}>
        <g className="style-scope yt-icon">
            <path
...
export const KeyBoardShortCutIcon = (color) => (
    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: "none", display: "block", width: "24", height: "24", fill: `#909090`}}>
        <g className="style-scope yt-icon">
            <path
